...
static bool sequences_equal(const emoji_scan_sequence_t* got, size_t got_n,
                            const emoji_scan_sequence_t* exp, size_t exp_n) {
  if (got_n != exp_n)
    return false;
...
static void print_diff(const emoji_scan_sequence_t* got, size_t got_n,
                       const emoji_scan_sequence_t* exp, size_t exp_n) {
